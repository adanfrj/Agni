...
public class DeployWind : MonoBehaviour
{
    [SerializeField]
    private GameObject windPrefab;
    private GameObject newWindPrefab;
    ...
    private void SpawnNewEnemy()
    {
        ...
        switch (randomSpawnZone)
        {
            case 0:
                ...
                randomYposition = Random.Range(-2f, -8f);
                break;
        ...
        newWindPrefab = Instantiate (windPrefab, spawnPosition, Quaternion.identity);
        rend = newWindPrefab.GetComponent<SpriteRenderer>();
